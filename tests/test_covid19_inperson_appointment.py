...
class TestCovid19InPersonPage:
    ...
    def setup(self, driver, BASE_URL):
        ...
        logger.info("Verify the accept all")
        ...
        logger.info("Verify the covid19 flu text is")
        ...
        logger.info("Verify the covid19 flu overview text is")
        ...
        logger.info("Click thecovid19 flu overview button")
        ...
        logger.info("Verify make an appointment")
        ...
        # assert "Book an In-Person Respiratory Appointment | PfizerForAll™" in self.covid19_inperson_page.get_text(self.covid19_inperson_page.TITLE), "PfizerForAll text is not displayed"
        logger.info("Verify title text is")
        ...
        logger.info("Verify the subtext is")
        ...
        logger.info("Verify the book appointment button")
    ...
    def test_verify_the_zocdoc_popup_covid19_inperson_appointment(self):
        ...
        self.covid19_inperson_page.wait_for_timeout(2)
        logger.info("Verify zocdoc title text is")
        ...
        logger.info("Verify continue to zocdoc button text")
        ...
        logger.info("Verify the Disclaimer text is")
    ...
    def test_verify_booking_is_quick_and_simple_section(self):
        ...
        logger.info("Verify the Booking subtext is")
        ...
        logger.info("Verify the step 2 tag text is")
        ...
        logger.info("Verify the step 2 text is")
        ...
        logger.info("Verify the Conformed tag text")
        ...
        logger.info("Verify the conformed heading text is")
    ...
    def test_verify_save_on_your_prescribed_pfizer_medications(self):
        ...
        logger.info("Verify the save prescribed medications section")
        self.covid19_inperson_page.is_visible(self.covid19_inperson_page.SAVE_PRESCRIBED_MEDICATIONS_SECTION), "Save prescribed medications section is not displayed"
        logger.info("Verify the save prescribed medications title text is")
        ...
        logger.info("Verify the save prescribed medications subtext is")
        ...
        logger.info("Verify the get started button text is")
    ...
    def test_verify_disclaimer_text_on_covid19_inperson_appointment(self):
        ...
        self.covid19_inperson_page.wait_for_timeout(2)
        logger.info("Verify the bottom of the disclaimer text is")
    ...
    def test_verify_faq_section(self):
        ...
        logger.info("Verify the fag 1 icon")
        ...
        logger.info("Click the fag 3 icon")
        self.covid19_inperson_page.click_fag_3_icon()
        logger.info("Verify the fag 4 icon")
